    ...
    <div className="relative mx-auto max-w-7xl px-6 py-20 lg:px-8">
      <div className="grid gap-16 md:grid-cols-12">
        <div className="md:col-span-7">
          <div className="mb-5 flex items-center gap-3">
            {/* text-white here used to be hardcoded - fine against the
                ...
                were added). text-primary-foreground is already computed
                per-theme for legible contrast against primary, whatever it is. */}
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-secondary text-sm font-black text-primary-foreground shadow-lg shadow-primary/25">{brandName?.charAt(0)}</div>
          ...
          <div className="flex gap-3">
            {socialLinks.map((s) => (
              <a key={s.platform} href={s.href} className="flex h-11 w-11 items-center justify-center rounded-2xl bg-muted text-muted-foreground transition-all duration-400 hover:-translate-y-1.5 hover:bg-gradient-to-br hover:from-primary hover:to-secondary hover:text-primary-foreground hover:shadow-lg hover:shadow-primary/25">
        ...
        <div className="md:col-span-5">
          ...
          <a href={ctaLink || "/contact"} className="inline-flex items-center gap-2.5 rounded-2xl bg-gradient-to-r from-primary to-secondary px-7 py-3.5 text-sm font-bold text-primary-foreground shadow-xl shadow-primary/25 transition-all duration-400 hover:scale-105 hover:shadow-2xl hover:shadow-primary/30">
