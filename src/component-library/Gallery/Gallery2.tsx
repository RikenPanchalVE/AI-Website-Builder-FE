  ...
  <section className="overflow-hidden bg-muted/30 py-24 lg:py-32">
    <div className="mx-auto max-w-6xl px-6 lg:px-8">
      <div className="mb-16 text-center">
        <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-primary/10 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-primary">Our Work</div>
